...
public class Instaciacao implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        userRepository.deleteAll(); //limpa os dados do MongoDB
        postRepository.deleteAll();

        User maria = new User(null, "Maria Brown", "maria@gmail.com");
        User alex = new User(null, "Alex Green", "alex@gmail.com");
        User bob = new User(null, "Bob Grey", "bob@gmail.com");
        userRepository.saveAll(Arrays.asList(maria,alex,bob)); //necessario salvar primeiro os usuarios antes de chamar o AuthorDTO
